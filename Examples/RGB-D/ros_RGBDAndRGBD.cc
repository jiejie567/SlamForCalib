...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::Image> rgb_sub1(nh, "/camera2/color/image_raw", 1000);
    message_filters::Subscriber<sensor_msgs::Image> depth_sub1(nh, "/camera2/aligned_depth_to_color/image_raw", 1000);
    message_filters::Subscriber<sensor_msgs::Image> rgb_sub2(nh, "/camera4/color/image_raw", 1000);
    message_filters::Subscriber<sensor_msgs::Image> depth_sub2(nh, "/camera4/aligned_depth_to_color/image_raw", 1000);
    // cout<<"建立订阅"<<endl;
