...
public:
    ...
    void GrabStereo(const sensor_msgs::ImageConstPtr& msgLeft1,const sensor_msgs::ImageConstPtr& msgRight1,const sensor_msgs::ImageConstPtr& msgLeft2,const sensor_msgs::ImageConstPtr& msgRight2);
...
{
    ros::init(argc, argv, "doubleStereo");
    ros::start();
